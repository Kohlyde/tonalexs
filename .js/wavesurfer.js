! function (t, e) {
    ...
    function s(t, e) {
        ...
        for (const [t, n] of Object.entries(e))
            if ("children" === t)
                for (const [t, n] of Object.entries(e)) "string" == typeof n ? i.appendChild(document.createTextNode(n)) : i.appendChild(s(t, n));
    ...
    class h extends e {
        ...
        initEvents() {
            ...
            if (this.wrapper.addEventListener("click", (e => {
                    ...
                    const {
                        ...
                        scrollWidth: e,
                        clientWidth: i
                    } = this.scrollContainer, s = t / e, n = (t + i) / e;
        ...
        scrollIntoView(t, e = !1) {
            const {
                ...
                scrollWidth: s,
                clientWidth: n
            } = this.scrollContainer, r = t * s, o = i, a = i + n, h = n / 2;
            if (this.isDragging) {
                const t = 30;
