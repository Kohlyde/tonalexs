...
! function () {
    ...
    var e = window.document,
        ...
        x = function (e, o, t) {
            if (null != e.readyState) {
                var r = "readystatechange",
                    a = function () {
                        if (o.test(e.readyState)) return w(e, r, a), t.apply(this, arguments)
                    };
                m(e, r, a)
            }
        },
        ...
        E = function (e, o, t) {
            ...
            if (((u === c || u === "gist." + c) && "archive" === h[3] || u === c && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || u === "codeload." + c) && (d.target = "_top"), "true" === b(o["data-show-count"]) && u === c && "marketplace" !== h[1] && "sponsors" !== h[1] && "orgs" !== h[1] && "users" !== h[1] && "-" !== h[1]) {
                var g, m;
        ...
        T = function (o, r) {
            if (null != o && null != r)
                if (o.getAttribute && (o = function (e) {
                    ...
                    G(n, [0, 0]), n.style.border = "none", n.style.colorScheme = "light";
                    var c = function () {
    ...
    o.protocol + "//" + o.host + o.pathname === i ? E(e.body, v(window.name || o.hash.replace(/^#/, "")), (function () {})) : function (o) {
        ...
        var o, t = e.querySelectorAll ? e.querySelectorAll("a." + n) : (o = [], u(e.getElementsByTagName("a"), (function (e) {
