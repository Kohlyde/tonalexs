(function () {
    ...
    document.addEventListener('contextmenu', function (event) {
        ...
        console.log("captureSender.js: clickedEl", window.clickedEl);
    });

    // Removed any stray characters that may have been causing errors
    ...
    if (chrome && chrome.runtime && chrome.runtime.onMessage) {
        ...
        console.error("chrome.runtime or chrome.runtime.onMessage is not available.");
    }
